    ...
    <div class="row justify-content-center my-4">
        <div class="col-lg-8 card p-4 p-lg-5">
            ...
            <div class="text-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">Update Catatan</h1>
            </div>
            <form action="<?= base_url('notes/updateAksi') ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id_note" value="<?= $note['id_notes'] ?>">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <img src="<?= $value['foto'] ?>" width="150px" id="preview" class="mt-4 rounded">
                        </div>
                    </div>
                </div>
