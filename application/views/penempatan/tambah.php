    ...
    <div class="row justify-content-center my-4">
        <div class="col-lg-8 card shadow px-4 px-lg-5 py-4">
            ...
            <div class="text-center mb-4">
                <h1 class="h3 text-gray-800">Tambah Penempatan</h1>
            </div>
            <form action="<?= base_url('penempatan/tambahAksi') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="barang" id="barang_service" value="<?= set_value('barang') ?>" autocomplete="off">
